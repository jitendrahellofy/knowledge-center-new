...
<VideoLayout
  url={"/assets/video/contact/group-management/from-contact-list.mp4"}
/>
...
<VideoLayout url={"/assets/video/contact/group-management/all-contacts.mp4"} />
...
<VideoLayout
  url={"/assets/video/contact/group-management/upload-from-excel.mp4"}
/>
...
<VideoLayout
  url={"/assets/video/contact/group-management/group-from-campaign.mp4"}
/>
