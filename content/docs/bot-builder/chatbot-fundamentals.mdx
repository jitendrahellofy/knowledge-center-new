...
<VideoLayout
  url={"/assets/video/chatbot/chatbot-fundamentals/01_trigger-point.mp4"}
/>

<VideoLayout
  url={"/assets/video/chatbot/chatbot-fundamentals/02_trigger-point.mp4"}
/>
...
<VideoLayout
  url={"/assets/video/chatbot/chatbot-fundamentals/chatbot-card-library.mp4"}
/>
...
<VideoLayout
  url={"/assets/video/chatbot/chatbot-fundamentals/creating-variables.mp4"}
/>
...
<VideoLayout
  url={"/assets/video/chatbot/chatbot-fundamentals/delete-variables.mp4"}
/>
...
<VideoLayout
  url={
    "/assets/video/chatbot/chatbot-fundamentals/card-validation-settings.mp4"
  }
/>
...
<VideoLayout
  url={"/assets/video/chatbot/chatbot-fundamentals/dropp-off-setting.mp4"}
/>
