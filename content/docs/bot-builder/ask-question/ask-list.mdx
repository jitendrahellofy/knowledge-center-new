...
<VideoLayout
  url={"/assets/video/chatbot/ask-list/01_what-is-the-ask-list-option-card.mp4"}
/>
...
<VideoLayout url={"/assets/video/chatbot/ask-list/02_header-type.mp4"} />
...
<VideoLayout url={"/assets/video/chatbot/ask-list/03_question-text.mp4"} />

**3. Footer**\
Add supporting text like your **company name** or **tagline.**\
Example: “Powered by Hellofy CRM.”

<VideoLayout url={"/assets/video/chatbot/ask-list/04_footer.mp4"} />

**4.Button Name**\
Customize the button users click to open the list.\
Example: “View Options” or “Browse Topics”

<VideoLayout url={"/assets/video/chatbot/ask-list/05_button-name.mp4"} />

**5. Options Type**\
Define up to **10 clickable options**, optionally grouped into **sections.**\
Great for: - Product categories - Support topics - Locations or branches - Any structured menu

<VideoLayout url={"/assets/video/chatbot/ask-list/06_options-type.mp4"} />
...
<VideoLayout
  url={"/assets/video/chatbot/ask-list/07_validation-settings.mp4"}
/>
...
<VideoLayout url={"/assets/video/chatbot/ask-list/08_once-you-re-done.mp4"} />
