...
<VideoLayout
  url={"/assets/video/chatbot/ask-text/01_what-is-the-ask-text-card.mp4"}
/>
...
<VideoLayout
  url={"/assets/video/chatbot/ask-text/02_formatting-your-question.mp4"}
/>
...
<VideoLayout
  url={"/assets/video/chatbot/ask-text/03_additional-validation-settings.mp4"}
/>
...
<VideoLayout
  url={"/assets/video/chatbot/ask-text/04_manage-the-ask-text-card.mp4"}
/>
