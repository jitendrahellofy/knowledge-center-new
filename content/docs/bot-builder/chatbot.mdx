...
<VideoLayout
  url={"/assets/video/chatbot/01_getting-started-with-chatbot-creation.mp4"}
/>
...
<VideoLayout url={"/assets/video/chatbot/02_edit-or-update-your-bot.mp4"} />
...
<VideoLayout
  url={
    "/assets/video/chatbot/03_chatbot-logs-view-user-responses-in-detail.mp4"
  }
/>
