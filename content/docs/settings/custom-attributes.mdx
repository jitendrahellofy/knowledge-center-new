  ...
  description={
    <>
      <p className="text-sm text-fd-foreground !my-0 px-2 py-2 font-semibold">
         💡 Ideal for personalizing outreach, segmenting customers, and managing CRM data with precision
      </p>
    </>
  }
/>
...
Go to Settings → Custom Attributes and click “+ Create an Attribute.”
...
<DefaultVector />
📽️ Need help? Watch the video above for a step-by-step guide to setting up custom attributes in Hellofy.
