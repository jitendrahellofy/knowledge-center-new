...
1. Navigate to **Campaign Centre** from the left sidebar.
2. Click on **Message Analytics** from the dropdown.
...
4. **Review Stats**:
        - **Message Sent** – This shows how many messages were sent out during the selected time period.
        - **Message Delivered** – Reflects how many of those sent messages were successfully delivered to recipients.
