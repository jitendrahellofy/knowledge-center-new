...
<VideoLayout
  url={
    "/assets/video/settings/subscription-wallet-management/wallet-management/where-to-find-it.mp4"
  }
/>
...
<VideoLayout
  url={
    "/assets/video/settings/subscription-wallet-management/wallet-management/add-credits.mp4"
  }
/>
...
<NoteInfo
  description={
    <p className="text-sm text-fd-foreground !my-0 px-2 py-2">
      ⚠️ Ensure your wallet has enough credits to avoid disruption in sending
      messages or running broadcasts.
    </p>
  }
/>
