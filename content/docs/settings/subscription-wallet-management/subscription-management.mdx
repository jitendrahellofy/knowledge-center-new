...
<VideoLayout
  url={
    "/assets/video/settings/subscription-wallet-management/subscription-management/where-to-find-it.mp4"
  }
/>
...
<VideoLayout
  url={
    "/assets/video/settings/subscription-wallet-management/subscription-management/upgrade-or-contact-support.mp4"
  }
/>
