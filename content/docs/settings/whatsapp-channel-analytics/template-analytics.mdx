...
Go to **Settings → WhatsApp channel & analytics → Template Analytics** to view and explore your template performance dashboard.
...
<VideoLayout
  url={
    "/assets/video/settings/whatsapp-channel-analytics/template-analytics/what-you-can-monitor.mp4"
  }
/>
