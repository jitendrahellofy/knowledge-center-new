...
<VideoLayout
  url={
    "/assets/video/settings/admin-user-control/department-management/how-to-create-a-department.mp4"
  }
/>
...
- Save the changes.
  <VideoLayout
    url={
      "/assets/video/settings/admin-user-control/department-management/edit-a-department.mp4"
    }
  />
...
- You’ll be prompted to confirm deletion.
  <VideoLayout
    url={
      "/assets/video/settings/admin-user-control/department-management/delete-a-department.mp4"
    }
  />
...
<NoteInfo
  ...
  description={
    <p className="text-sm text-fd-foreground !my-0 px-2 py-2">
      ⚠️ Before deleting, make sure there are no active users or dependencies in
      the department.
    </p>
  }
/>
...
- You can manage users from there via the **User Management** section.
  <VideoLayout
    url={
      "/assets/video/settings/admin-user-control/department-management/viewing-members-in-a-department.mp4"
    }
  />
