...
<NoteInfo
  description={
    <p className="text-sm text-fd-foreground !my-0 px-2 py-2">
      ...
      is a placeholder that will dynamically display the user's actual OTP at
      the time of sending.
    </p>
  }
/>
...
- Next for message validity period, WhatsApp allows a max validity of **10 minutes** for authentication messages by default.If you want to set a **custom validity** (up to 15 minutes), you can do it here.
  <NoteInfo
    description={
      <p className="text-sm text-fd-foreground !my-0 px-2 py-2">
        📝<strong> Note:</strong> If the message is not delivered within this
        period, you won't be charged and the user won't receive the
        message.{" "}
      </p>
    }
  />
