...
<NoteInfo
  description={
     <p className="text-sm text-fd-foreground !my-0 px-2 py-2"> ⚠️ If a template includes <strong>both promotional and transactional content</strong>, it will be categorized as <strong>Marketing</strong> by Meta.</p>
  }
  />

## 📝 Quick Tip
#### Not sure which category your message fits into?\
Here’s a simple rule:\
_If it’s not a utility (user-triggered) or authentication (OTP) message, it’s marketing._